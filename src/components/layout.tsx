...
const SocialLink: FC<{ href: string; label: string; children: ReactNode }> = ({
  href,
  label,
  children,
}) => (
...
const Twitter = () => (
  <SocialLink href="https://twitter.com/jdinhify" label="Visit my Twitter">
    <svg
...
const LinkedIn = () => (
  <SocialLink href="https://linkedin.com/in/jdinhify" label="Visit my LinkedIn">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="23"
      height="23"
...
const GitHub = () => (
  <SocialLink
    href="https://github.com/jdinhify/jdinh-life"
    label="Visit this site's GitHub"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="23"
